...
model_path = "/data/mentianyi/code/Visual-RFT/Qwen2-VL-2B_GRPO_coco_base65cate_6k/checkpoint-100"
ori_processor_path = "/home/mentianyi/my_huggingface/Qwen/Qwen2-VL-2B-Instruct"
...
def main():
    ...
    with open('/data/mentianyi/code/Visual-RFT/raw_data/coco_anno/instances_val2017.json', 'r') as json_file:
    ...
    for image in tqdm(split_images):
        ...
        for cate in exist_cat[str(image_id)]:
            ...
            selected_cate = ['mouse', 'fork', 'hot dog', 'cat', 'airplane', 'suitcase', 'parking meter', 'sandwich',
                             'train', 'hair drier', 'toilet', 'toaster', 'snowboard', 'frisbee', 'bear']
            if category not in selected_cate:
                continue
